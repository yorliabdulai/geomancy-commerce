      ...
      <table className="table table-compact w-full">
        ...
        <tbody>
          {order?.cartItems?.length > 0 ? (
                  ...
                  <td>
                    <Link to={`/product-details/${productId}`}>
                      ...
                      <div className="md:text-lg font-medium">
                        Qty: <span className="md:text-lg font-medium text-primary">{qty}</span>
                      </div>
                      <div className="md:text-lg font-medium">
                        Total: <span className="md:text-lg font-medium text-primary">{formatPrice(price * qty)}</span>
                      </div>
                    </Link>
                  </td>
                  {user && (
            ...
            <tr>
              <td colSpan={user ? 2 : 1} className="text-center">
